      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-5 md:grid-cols-2">
        <div className="relative mx-auto w-full max-w-sm">
          ...
          <img
            ...
            alt="Faly, technicien installateur satellite"
            loading="lazy"
            width={1024}
            height={1280}
        ...
        <div>
          <h2 className="text-3xl sm:text-4xl">
            Faly, votre <span className="text-gradient-brand">installateur agréé</span>
          </h2>
          ...
          <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground sm:text-base">
            <p>
              ...
              <strong className="text-foreground">12 ans</strong>, je me suis spécialisé dans la
              pose d'antennes paraboliques et la mise en service des décodeurs Canal+.
            </p>
            <p>
              Chaque installation est réalisée dans les règles de l'art : fixation sécurisée,
              câblage discret, orientation millimétrée du satellite et test complet du signal avant
              de vous laisser la télécommande.
            </p>
            <p>
              Mon objectif est simple :{" "}
              <strong className="text-foreground">
                que vous profitiez de toutes vos chaînes, sans coupure, dès le jour de mon passage.
              </strong>
            </p>
          </div>
