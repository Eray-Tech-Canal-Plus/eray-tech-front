...
function ArticleDetail({ article, onBack, onOpen }: ArticleDetailProps) {
  ...
  return (
    <div
      className="et-fade-up w-full"
      style={{ fontFamily: "'Inter', sans-serif", background: "#FFFFFF", color: "#1F1F1F" }}
    >
      <div className="relative overflow-hidden bg-black">
        ...
        <div className="w-full px-6 md:px-10 pt-14 pb-16 relative">
          ...
          <div className="flex items-center gap-3">
            <div
              style={{ background: "#F97316" }}
              className="w-9 h-9 rounded-full flex items-center justify-center text-black text-xs font-bold"
            >
      ...
      <article className="w-full px-6 md:px-10 pb-16 -mt-4 md:-mt-6 max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mt-10 pt-8 border-t border-gray-200">
          ...
          <button
            onClick={onBack}
            className="et-btn-secondary text-sm font-semibold px-5 py-2.5 rounded-xl"
          >
            Retour aux articles
          </button>
        </div>
    ...
    >
      ...
      <section className="relative overflow-hidden bg-black">
        ...
        <div className="w-full px-6 md:px-10 pt-20 pb-24 relative">
          ...
          <p className="text-white/60 text-base md:text-lg mt-6 max-w-xl leading-relaxed">
            Coulisses techniques, actualités séries, sport en direct et culture numérique —
            décryptés par notre rédaction.
          </p>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-black">
        ...
        <div className="w-full px-6 md:px-10 py-20 text-center relative">
          <div
            style={{ background: "#F97316" }}
            className="w-11 h-11 rounded-2xl flex items-center justify-center mx-auto mb-6"
          >
          ...
          <p className="text-white/55 text-sm mb-8 max-w-md mx-auto">
            Recevez notre meilleure sélection chaque vendredi. Désabonnement en un clic, à tout
            moment.
          </p>
          <form
          ...
          >
            ...
            />
            <button
              className="et-btn-primary text-sm font-semibold px-6 py-3 rounded-xl"
