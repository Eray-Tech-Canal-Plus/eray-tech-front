...
export const marquesApi = {
  ...
  update: (id: number, data: Partial<Marque>) =>
    api.put<Marque>(`/marques/${id}`, data).then((r) => r.data),
...
export const categoriesApi = {
  ...
  create: (data: Partial<Categorie>) =>
    api.post<Categorie>("/categories", data).then((r) => r.data),
  update: (id: number, data: Partial<Categorie>) =>
    api.put<Categorie>(`/categories/${id}`, data).then((r) => r.data),
...
export const phonesApi = {
  ...
  update: (id: number, data: Partial<Phone>) =>
    api.put<Phone>(`/phones/${id}`, data).then((r) => r.data),
...
export const reservationServiceApi = {
  ...
  get: (id: number) =>
    api.get<ReservationService>(`/reservation-service/${id}`).then((r) => r.data),
...
export const dashboardApi = {
  ...
  recentReservations: () =>
    api.get<Reservation[]>("/reservations?sort=recent&limit=5").then((r) => r.data),
