      ...
      <div className="relative w-full max-w-md">
        <div className="rounded-2xl border border-slate-700/50 bg-slate-800/50 p-8 shadow-2xl backdrop-blur-xl">
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <p className="mt-1 text-sm text-slate-400">Phones & Canal+ — Connectez-vous pour accéder</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="password" className="mb-1.5 block text-sm font-medium text-slate-300">Mot de passe</label>
              <div className="relative">
